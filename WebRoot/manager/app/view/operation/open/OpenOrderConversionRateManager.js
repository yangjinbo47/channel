Ext.define('CMS.view.operation.open.OpenOrderConversionRateManager', {
	extend : 'Ext.panel.Panel',
	xtype : 'openOrderConversionRateView',
	layout : 'fit',
	...
	initComponent : function() {
		...
		this.chart = Ext.create('Ext.chart.Chart', {
			...
			animate : true,
			shadow: true,
			store : 'CMS.store.operation.open.OpenOrderConversionRateStore',
			axes : [{
						type : 'Numeric',
						position : 'left',
						fields : ['rate','rateReq'],
