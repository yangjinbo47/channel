Ext.define('CMS.view.operation.sms.SmsAppReportPanel', {
	extend : 'Ext.form.Panel',
	xtype : 'smsAppReportPanel',
	id : 'smsAppReportPanel',
	layout : 'fit',
...
//			autoLoad : true,
			proxy : {
				type : 'ajax',
				url : '../operation/smsApp_report.action',
				reader : {
					type : 'json',
					total : 'total',
					root : 'report'
		...
		this.items = [ {
			...
			tbar : ['起始时间',{
				...
				validator : function(){
					var rawValue = this.getRawValue(), endField = Ext.getCmp('smsapp_endtime'),endRawValue = endField.getRawValue();
				...
				validateOnChange : false,
				validator : function(){
					var rawValue = this.getRawValue(), startField = Ext.getCmp('smsapp_starttime'),startRawValue = startField.getRawValue();
