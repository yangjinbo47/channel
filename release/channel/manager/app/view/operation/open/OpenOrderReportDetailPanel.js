Ext.define('CMS.view.operation.open.OpenOrderReportDetailPanel', {
	extend : 'Ext.form.Panel',
	xtype : 'openOrderReportDetailPanel',
	id : 'openOrderReportDetailPanel',
	plain : true,
	layout : 'fit',
	fieldDefaults : {
		labelWidth : 50,
...
//			autoLoad : true,
			proxy : {
				type : 'ajax',
				url : '../operation/openOrder_provinceDetail.action',
				reader : {
					type : 'json',
					total : 'total',
					root : 'reports'
