Ext.define('CMS.view.operation.open.OpenSellerReportPanel', {
	extend : 'Ext.form.Panel',
	xtype : 'openSellerReportPanel',
	id : 'openSellerReportPanel',
	layout : 'fit',
...
//			autoLoad : true,
			proxy : {
				type : 'ajax',
				url : '../operation/openSeller_report.action',
				reader : {
					type : 'json',
					total : 'total',
					root : 'report'
		...
		this.items = [ {
			...
			tbar : ['起始时间',{
				...
				validator : function(){
					var rawValue = this.getRawValue(), endField = Ext.getCmp('openseller_endtime'),endRawValue = endField.getRawValue();
				...
				xtype:'datetimefield',
				name : 'endTime',
				id : 'openseller_endtime',
				allowBlank : false,
				format : 'Y-m-d',
				validateOnBlur : true,
				validateOnChange : false,
				validator : function(){
					var rawValue = this.getRawValue(), startField = Ext.getCmp('openseller_starttime'),startRawValue = startField.getRawValue();
