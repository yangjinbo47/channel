...
@Entity
@Table(name = "T_SMS_ORDER_CONVERSIONRATE")
public class TSmsOrderConversionrate extends IdEntity implements Comparable<TSmsOrderConversionrate>{
	...
	@Override
	public int compareTo(TSmsOrderConversionrate entity) {
